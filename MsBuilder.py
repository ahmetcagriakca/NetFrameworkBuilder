...
class MsBuilder:
	...
	def build(self, projPath, rebuild=None):
		...
		arg5 = '-consoleloggerparameters:ErrorsOnly;ShowTimestamp'#'-consoleloggerparameters:PerformanceSummary;NoSummary -verbosity:minimal'
		arg6 = ''#'-noconsolelogger'
		p = subprocess.call([self.msbuild, projPath, arg1, arg2, arg3, arg4, arg5, arg6])
